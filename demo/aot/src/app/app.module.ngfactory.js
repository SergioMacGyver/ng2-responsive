...
var import27 = require('@angular/core/src/i18n/tokens');
var import28 = require('@angular/core/src/error_handler');
var import29 = require('@angular/platform-browser/src/dom/dom_tokens');
var import30 = require('@angular/platform-browser/src/dom/animation_driver');
var import31 = require('@angular/core/src/render/api');
var import32 = require('@angular/core/src/security');
var import33 = require('@angular/core/src/change_detection/differs/iterable_differs');
var import34 = require('@angular/core/src/change_detection/differs/keyvalue_differs');
var AppModuleInjector = (function (_super) {
    __extends(AppModuleInjector, _super);
    function AppModuleInjector(parent) {
        _super.call(this, parent, [import20.AppComponentNgFactory], [import20.AppComponentNgFactory]);
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_13", {
        get: function () {
            if ((this.__APP_ID_13 == null)) {
                (this.__APP_ID_13 = import21._appIdRandomProviderFactory());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_17", {
        get: function () {
            if ((this.__EventManager_17 == null)) {
                (this.__EventManager_17 = new import12.EventManager(this._EVENT_MANAGER_PLUGINS_16, this.parent.get(import24.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_21", {
        get: function () {
            if ((this.__RootRenderer_21 == null)) {
                (this.__RootRenderer_21 = import25._createConditionalRootRenderer(this._DomRootRenderer_20, this.parent.get(import25.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ResponsiveConfig_29", {
        get: function () {
            if ((this.__ResponsiveConfig_29 == null)) {
                (this.__ResponsiveConfig_29 = import1.ResponsiveDefinition());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ResponsiveState_30", {
        get: function () {
            if ((this.__ResponsiveState_30 == null)) {
                (this.__ResponsiveState_30 = new import18.ResponsiveState(this._ResponsiveConfig_29));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ResponsiveModule_3 = new import5.ResponsiveModule();
        ...
        this._ApplicationRef__10 = new import9.ApplicationRef_(this.parent.get(import24.NgZone), this.parent.get(import26.Console), this, this._ErrorHandler_7, this, this._ApplicationInitStatus_8, this.parent.get(import8.TestabilityRegistry, null), this._Testability_9);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import5.ResponsiveModule)) {
            return this._ResponsiveModule_3;
        }
        if ((token === import1.AppModule)) {
            return this._AppModule_4;
        }
        if ((token === import27.LOCALE_ID)) {
            return this._LOCALE_ID_5;
        }
        if ((token === import6.NgLocalization)) {
            return this._NgLocalization_6;
        }
        if ((token === import28.ErrorHandler)) {
        ...
        if ((token === import18.ResponsiveConfig)) {
            return this._ResponsiveConfig_29;
        }
        if ((token === import18.ResponsiveState)) {
            return this._ResponsiveState_30;
        }
